...
from stealth_browser_mcp.dynamic_hook_system import HookAction, RequestInfo
    ...
    async def execute_response_action(self, tab, request: RequestInfo, action: HookAction, event) -> None:
        ...
        try:
            ...
            if action.action == "block":
                ...
                debug_logger.log_info("response_stage", "execute_response_action",
    ...
    async def execute_request_action(self, tab, request: RequestInfo, action: HookAction) -> None:
        ...
        try:
            ...
            if action.action == "block":
                ...
                debug_logger.log_info("response_stage", "execute_request_action",

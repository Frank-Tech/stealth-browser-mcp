    ...
    async def extract_element_structure(
        ...
        try:
            ...
            if hasattr(structure_data, 'exception_details'):
                ...
                debug_logger.log_info("element_cloner", "extract_structure",
                ...
                debug_logger.log_warning("element_cloner", "extract_structure",
    ...
    async def extract_element_animations(
        ...
        try:
            ...
            if hasattr(animation_data, 'exception_details'):
                ...
                debug_logger.log_warning("element_cloner", "extract_animations",
            ...
            if fetch_external and isinstance(asset_data, dict):
                ...
                for bg_img in asset_data.get('background_images', []):
                    try:
                        ...
                        debug_logger.log_warning("element_cloner", "extract_assets",
    ...
    async def extract_related_files(
        ...
        try:
            ...
            if hasattr(file_data, 'exception_details'):
                ...
                debug_logger.log_warning("element_cloner", "extract_related_files",
        ...
        for stylesheet in file_data['stylesheets']:
            if stylesheet.get('href') and stylesheet['href'] not in self.extracted_files:
                try:
                    ...
                    debug_logger.log_warning("element_cloner", "fetch_css",
        ...
        for script in file_data['scripts']:
            if script.get('src') and script['src'] not in self.extracted_files:
                try:
                    ...
                    debug_logger.log_warning("element_cloner", "fetch_js",
    ...
    async def clone_element_complete(
        ...
        try:
            ...
            if 'structure' in default_options:
                tasks.append(
                    ('structure', self.extract_element_structure(tab, element, **default_options['structure'])))
            ...
            if 'animations' in default_options:
                tasks.append(
                    ('animations', self.extract_element_animations(tab, element, **default_options['animations'])))
            ...
            debug_logger.log_info("element_cloner", "clone_complete",
                ...
                for inherited_entry in matched_styles[4]:
                    if inherited_entry.inline_style:
                        result["inheritance_chain"].append({
                            ...
                            "properties": len(
                                inherited_entry.inline_style.css_properties) if inherited_entry.inline_style.css_properties else 0
                        })

            debug_logger.log_info("element_cloner", "extract_styles_cdp",
